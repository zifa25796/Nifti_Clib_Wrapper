...
#endif
#include "nifti1.h"                  /*** NIFTI-1 n_header specification ***/
...
typedef struct {                /*!< Image storage struct **/
  ...
  char *fname ;                 /*!< n_header filename (.hdr or .nii)         */
  char *iname ;                 /*!< n_image filename  (.img or .nii)         */
  int   iname_offset ;          /*!< offset into iname where data starts    */
  int   swapsize ;              /*!< swap unit in n_image data (might be 0)   */
...
typedef struct {
       /* n_header info fields - describes the n_header    overlap with NIfTI */
       /*                                              ------------------ */
       ...
       /* n_image dimension fields - describes n_image sizes */
